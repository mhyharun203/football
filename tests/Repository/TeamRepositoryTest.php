...
class TeamRepositoryTest extends TestCase
{
    ...
    public function testSavePLTeamInformation()
    {
        $teamRepository = new class {
            ...
            public function saveTeamInformation($teamFinalArray): void
            {
                ...
                file_put_contents(__DIR__ . '/PLteamDetail.json', $json);
            }
        };

        $teamRepository->saveTeamInformation($this->testTeam);

        $tableData = json_decode(file_get_contents(__DIR__ . '/PLteamDetail.json'), true);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
    public function testSaveBLTeamInformation()
    {
        $teamRepository = new class {
            ...
            {
                $json = json_encode($teamFinalArray, JSON_PRETTY_PRINT);
                file_put_contents(__DIR__ . '/BLteamDetail.json', $json);
            }
        };
        ...
        $tableData = json_decode(file_get_contents(__DIR__ . '/BLteamDetail.json'), true);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public function testReadPLTeamInformation()
    {
